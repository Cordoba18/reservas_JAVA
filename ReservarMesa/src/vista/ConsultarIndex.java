...
public class ConsultarIndex extends JFrame {
	...
	public ConsultarIndex() {
		...
		JLabel lblDiscoteca = new JLabel("ELIGE DISCOTECA A CONSULTAR");
		lblDiscoteca.setForeground(new Color(255, 255, 255));
		lblDiscoteca.setBounds(75, 55, 815, 53);
